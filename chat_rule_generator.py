...
# prompt_dict['context'] = (
#     'You are an automated reasoning engine capable of generating as many new, most relevant temporal logic rules corresponding to the "{head}(X,Y,T)" based on chains and subgraphs, ensuring they conform to the definition of temporal logic rules.\n\n'
#     'Here are a few examples: \n'
#     'head: Cooperate_economically(X,Y,T)\n'
#     'chain rules:\n'
#     'Cooperate_economically(X0,X1,T1)<-Provide_aid(X0,X1,T0)\n'
#     'Cooperate_economically(X0,X2,T2)<-Host_a_visit(X0,X1,T0)&Express_intent_to_meet_or_negotiate(X1,X2,T1)\n'
#     'Cooperate_economically(X0,X3,T3)<-inv_Make_a_visit(X0,X1,T0)&inv_Host_a_visit(X1,X2,T1)&Consult(X2,X3,T2)\n'
#     'Cooperate_economically(X0,X1,T1)<-inv_Express_intent_to_meet_or_negotiate(X0,X1,T0)\n'
#     'Cooperate_economically(X0,X3,T3)<-inv_Make_a_visit(X0,X1,T0)&Make_statement(X1,X2,T1)&inv_Consult(X2,X3,T2)\n'
#
#     'subgraphs:\n'
#     '[[246, 103, 4293, 57], [4293, 283, 1120, 57]  [1120, 98, 112, 57], [246, 103, 112, 72], [246, 385, 369, 57], [369, 372, 423, 58], [423, 53, 112, 72], [246, 54, 112, 90]]\n\n'
#
#     'Generated Temporal logical rules:\n'
#     'Cooperate_economically(X0,X1,T1)<-Engage_in_negotiation(X0,X1,T0)\n'
#     'Cooperate_economically(X0,X2,T2)<-inv_Engage_in_negotiation(X0,X1,T0)&Make_a_visit(X1,X2,T1)\n'
#     'Cooperate_economically(X0,X3,T3)<-Engage_in_negotiation(X0,X1,T0)&inv_Consult(X1,X2,T1)&Engage_in_diplomatic_cooperation(X2,X3,T2)\n'
#     'Cooperate_economically(X0,X3,T3)<-inv_Make_statement(X0,X1,T0)&Make_an_appeal_or_request(X1,X2,T1)&Express_intent_to_meet_or_negotiate(X2,X3,T2)\n\n'
#
#
#     'head: Appeal_for_change_in_institutions,_regime(X,Y,T)\n'
#     'chain rules:\n'
#     'Appeal_for_change_in_institutions,_regime(X0,X2,T2)<-inv_Rally_support_on_behalf_of(X0,X1,T0)&Appeal_for_change_in_institutions,_regime(X1,X2,T1)\n'
#     'Appeal_for_change_in_institutions,_regime(X0,X3,T3)<-Appeal_for_change_in_institutions,_regime(X0,X1,T0)&Reject_proposal_to_meet,_discuss,_or_negotiate(X1,X2,T1)&inv_Consult(X2,X3,T2)\n'
...
#
#     'subgraphs:\n'
#     '[[1273, 15, 5244, 180], [1273, 156, 5244, 163], [1273, 15, 5046, 133], [5046, 142, 4293, 172], [4293, 286, 5244, 173]]\n\n'
#
#     'Generated Temporal logical rules:\n'
...
#
#
#     'head: Appeal_for_economic_aid(X,Y,T)\n'
#     'chain rules:\n'
...
#
#     'subgraphs:\n'
#     '[[2547, 21, 2427, 54], [2547, 156, 4150, 23], [4150, 27, 2427, 27], [2547, 386, 6977, 33], [6977, 160, 2427, 34], [2547, 291, 6795, 21], [6795, 231, 6979, 40], [6979, 156, 2427, 40], [2547, 98, 2427, 27]]\n\n'
#
#     'Generated Temporal logical rules:\n'
...
#     'Appeal_for_economic_aid(X0,X3,T3)<-inv_Make_an_appeal_or_request(X0,X1,T0)&Accuse(X1,X2,T1)&Make_statement(X2,X3,T2)\n'
